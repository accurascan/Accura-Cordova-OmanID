...
-(void) LivenessData:(NSString*)stLivenessValue livenessImage:(UIImage*)livenessImage status:(bool)status imagePath:(NSString*)imagePath errorMSG:(NSString*)errorMSG;
